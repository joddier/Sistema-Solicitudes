        ...
        <?php
          ...
          echo '<tr>
                  ...
                  <td>
                    ...
                    <button class="btn btn-warning btnEditarUsuario" idUsuario="'.$value["id"].'"data-toggle="modal" data-target="#modalEditarUsuario"><i class="fa fa-pencil"></i>
                    </button>
...
<div id="modalEditarUsuario" class="modal fade" role="dialog">s
  <div class="modal-dialog">
            ...
            <div class="form-group">
              ...
              <input type="file" class="nuevaFoto" name="editarFoto">
                ...
                <input type="hidden" name="fotoActual" id="fotoActual">
                                        ...
                                        <!-- Footer-botones del modal EDITAR  -->
